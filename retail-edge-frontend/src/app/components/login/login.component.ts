    ...
    <div class="auth-container">
      ...
      <div class="form-panel">
        <div class="form-content">
          ...
          <p class="form-subtitle">Sign in to continue to Retail Edge.</p>
      ...
      <div class="branding-panel">
        <div class="branding-content">
          ...
          <h2 class="brand-tagline">Streamline Your Entire Retail Operation.</h2>
          <p class="brand-description">
            From product catalog management to sales analytics, get the tools you need to succeed.
          </p>
...
export class LoginComponent {
  ...
  onSubmit(): void {
    ...
    this.authService.login({ email: this.email, password: this.password }).subscribe({
      ...
      error: (err) => {
        this.loading.set(false);
        this.apiError.set(err.error?.message || 'Invalid email or password');
      }
    });
  }
}
